...
```sql
SELECT * 
FROM `solid-authority-448207-q6.dbt_tyeejian.fct_fhv_monthly_zone_traveltime_p90` 
where 
pickup_zone in ('Newark Airport', 'SoHo', 'Yorkville East') and month = 11 and year = 2019
